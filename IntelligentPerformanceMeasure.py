...
# Instancia de la clase IntelligentPlagiarismChecker
...
def evaluar_sospechosos():
    ...
    print(f'AUC Calculado Manualmente: {round(area_bajo_curva, 4)}')
    # Graficar la curva roc
    # Lista de umbrales
    umbrales = [40, 50, 60, 70, 80]
    ...
    for umbral in umbrales:
        ...
        print(f"Umbral: {umbral}, AUC Sklearn: {roc_auc}")
