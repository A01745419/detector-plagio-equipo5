...
# Elimina palabras que no dan contexto
...
class IntelligentPlagiarismChecker:
    ...
    def lematizacion(self, oraciones):
        ...
        lematized_tokens = [palabra.lemma_ for palabra in
                            palabras if palabra.lemma_ not in stop_words]
    ...
    def entrenar_modelo_plagio(self):
        ...
        grid_search = GridSearchCV(
            modelo, param_grid, cv=5, scoring='accuracy')
        ...
        print(f"Precisión del modelo: {best_model.score(X_test, y_test)}")
        print("")
        return best_model
